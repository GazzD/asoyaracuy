			        ...
			        <ul class="nav navbar-nav">
			          ...
			          <li class="dropdown user user-menu">
			            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
			              ...
			              <span class="hidden-xs">{{$authUser->house}}</span>
			            </a>
			            <ul class="dropdown-menu">
			              <!-- User image -->
			              <li class="user-header">
			                ...
			                <p>
			                  Quinta - {{$authUser->house}}
			                  <small>&Uacute;ltima actualizaci&oacute;n {{$authUser->updated_at}}</small>
			                </p>
			              </li>
			              <!-- Menu Footer-->
			              <li class="user-footer">
			                ...
			                <div class="pull-right">
			                  <a href="{{route('admin-logout')}}" class="btn btn-default btn-flat">Cerrar Sessi&oacute;n</a>
			                </div>
			              </li>
			            </ul>
			          </li>
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li class="active treeview">
							{!! HTML::decode(link_to_route('admin', '<i class="fa fa-dashboard"></i><span>Dashboard</span>')) !!}
						</li>
						<li class="treeview">
							@if($payments_count > 0)
							{!! HTML::decode(link_to_route('admin.payments', '<i class="fa fa-files-o"></i> <span>Pagos</span> <span class="label label-primary pull-right">'.$payments_count.'</span>')) !!}
							@else
